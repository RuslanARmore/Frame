...
enum MULogLevel: String {
    ...
    static var allValues: [MULogLevel] { return [.details, .event, .error, .critical] }
}

// MARK: - MULogManager

final class MULogManager: NSObject {
    ...
    public static var isLogingEnabled: Bool {
...
class FormattedConsoleDestination: BaseQueuedDestination {
    ...
    override func write(message: String) {
        ...
        MULogManager.collectedLogs.append(message + "\n")
