...
class MUCacheManager: NSObject {
    ...
    class func addExcludedNonCachingObject(with key: String) {
    ...
    class func cache(objects: [MUCodable], forKey key: String, failure: ((Error) -> Void)? = nil) {
    ...
    class func read<Object: MUCodable>(forKey key: String, to objectsType: Object.Type) -> [Object]? {
